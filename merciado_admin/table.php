...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- //bootstrap-css -->
    <!-- Custom CSS -->
    <link href="../merciado_admin/css/UI.css" rel='stylesheet' type='text/css' />
...
<body>
    <section id="container">
        ...
        <header class="header fixed-top clearfix">
            <!--logo start-->
            <div class="brand">
                <a href="index.php" class="logo"><span class="fa fa-pagelines" aria-hidden="true"></span>
                    Merciado
                </a>
            </div>
            <!--logo end-->
...
if(isset($_POST['btn_delete'])){
        if(isset($_POST['delete'])){
            ...
            for($i=0;$i<count($checkbox);$i++){
                $del_acc = $checkbox[$i];
                $deleteUser="DETELE from users WHERE account ='$del_acc'";
